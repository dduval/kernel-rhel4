...
module_param_array1(index, int, NULL, 0444);
MODULE_PARM_DESC(index, "Index value for Intel HD audio interface.");
module_param_array1(id, charp, NULL, 0444);
MODULE_PARM_DESC(id, "ID string for Intel HD audio interface.");
module_param_array1(enable, bool, NULL, 0444);
MODULE_PARM_DESC(enable, "Enable Intel HD audio interface.");
module_param_array1(model, charp, NULL, 0444);
MODULE_PARM_DESC(model, "Use the given board model.");
module_param_array1(position_fix, int, NULL, 0444);
MODULE_PARM_DESC(position_fix, "Fix DMA pointer "
		 "(0 = auto, 1 = none, 2 = POSBUF).");
module_param_array1(bdl_pos_adj, int, NULL, 0444);
MODULE_PARM_DESC(bdl_pos_adj, "BDL position adjustment offset.");
module_param_array1(probe_mask, int, NULL, 0444);
...
static int azx_suspend(struct pci_dev *pci, pm_message_t state)
{
	...
	pci_save_state(pci, pci->saved_config_space);
...
static int azx_resume(struct pci_dev *pci)
{
	...
	pci_restore_state(pci, pci->saved_config_space);
