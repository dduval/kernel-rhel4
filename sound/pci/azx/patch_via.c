...
static snd_kcontrol_new_t vt1708_control_templates[] = {
 ...
 * input MUX handling
 */
static int via_mux_enum_info(snd_kcontrol_t *kcontrol,
...
static int via_mux_enum_get(snd_kcontrol_t *kcontrol,
...
static int via_mux_enum_put(snd_kcontrol_t *kcontrol,
			    snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct via_spec *spec = codec->spec;
...
static snd_kcontrol_new_t vt1708_capture_mixer[] = {
...
/* capture mixer elements */
static snd_kcontrol_new_t vt1709_capture_mixer[] = {
