...
static int conexant_mux_enum_info(snd_kcontrol_t *kcontrol,
...
static int conexant_mux_enum_get(snd_kcontrol_t *kcontrol,
...
static int conexant_mux_enum_put(snd_kcontrol_t *kcontrol,
				 snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int cxt_eapd_info(snd_kcontrol_t *kcontrol,
			      snd_ctl_elem_info_t *uinfo)
{
...
static int cxt_eapd_get(snd_kcontrol_t *kcontrol,
			     snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int cxt_eapd_put(snd_kcontrol_t *kcontrol,
			     snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int conexant_ch_mode_info(snd_kcontrol_t *kcontrol,
				 snd_ctl_elem_info_t *uinfo)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int conexant_ch_mode_get(snd_kcontrol_t *kcontrol,
				snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int conexant_ch_mode_put(snd_kcontrol_t *kcontrol,
				snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int cxt5045_hp_master_sw_put(snd_kcontrol_t *kcontrol,
				    snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int cxt5045_hp_master_vol_put(snd_kcontrol_t *kcontrol,
				     snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
...
static snd_kcontrol_new_t cxt5045_mixers[] = {
	{
...
static snd_kcontrol_new_t cxt5045_test_mixer[] = {
...
/* turn on/off EAPD (+ mute HP) as a master switch */
static int cxt5047_hp_master_sw_put(snd_kcontrol_t *kcontrol,
				    snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	struct conexant_spec *spec = codec->spec;
...
static int cxt5047_hp_master_vol_put(snd_kcontrol_t *kcontrol,
				     snd_ctl_elem_value_t *ucontrol)
{
	struct hda_codec *codec = snd_kcontrol_chip(kcontrol);
	long *valp = ucontrol->value.integer.value;
...
static snd_kcontrol_new_t cxt5047_mixers[] = {
...
static snd_kcontrol_new_t cxt5047_toshiba_mixers[] = {
	{
		.iface = SNDRV_CTL_ELEM_IFACE_MIXER,
		.name = "Capture Source",
		.info = conexant_mux_enum_info,
...
static snd_kcontrol_new_t cxt5047_hp_mixers[] = {
	{
		.iface = SNDRV_CTL_ELEM_IFACE_MIXER,
		.name = "Capture Source",
		.info = conexant_mux_enum_info,
...
static snd_kcontrol_new_t cxt5047_test_mixer[] = {
