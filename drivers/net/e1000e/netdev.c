			...
			unsigned int mss)
{
	...
	while (len) {
		...
		if (tx_ring->last_tx_tso && !skb_shinfo(skb)->tso_size) {
			tx_ring->last_tx_tso = 0;
			if (!skb->data_len)
				size -= 4;
		}
...
static struct pci_device_id e1000e_pci_tbl[] = {
	...
	*/
	...
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, E1000_DEV_ID_ICH9_IFE),
	  .driver_data = board_ich9lan },
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, E1000_DEV_ID_ICH9_IFE_G),
	  .driver_data = board_ich9lan },
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, E1000_DEV_ID_ICH9_IFE_GT),
	  .driver_data = board_ich9lan },
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, E1000_DEV_ID_ICH9_IGP_AMT),
	  .driver_data = board_ich9lan },
	{ PCI_DEVICE(PCI_VENDOR_ID_INTEL, E1000_DEV_ID_ICH9_IGP_C),
	  .driver_data = board_ich9lan },
