...
static void e1000e_downshift_workaround(struct net_device *netdev)
{
 ...
 **/
static void e1000e_update_phy_task(struct net_device *netdev)
{
	struct e1000_adapter *adapter = netdev_priv(netdev);
				 ...
				 const struct pci_device_id *ent)
{
	...
	/* needed to move this down, so adapter is initialized */
	...
	INIT_WORK(&adapter->downshift_task,
		(void (*)(void *))e1000e_downshift_workaround, netdev);
	INIT_WORK(&adapter->update_phy_task,
		(void (*)(void *))e1000e_update_phy_task, netdev);
