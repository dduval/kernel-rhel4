...
static unsigned int tx_fifo_len[MAX_TX_FIFOS] =
    {[0 ...(MAX_TX_FIFOS - 1)] = 0 };
static int num_tx_fifo_len = 0;
static unsigned int rx_ring_num = 1;
static unsigned int rx_ring_sz[MAX_RX_RINGS] =
    {[0 ...(MAX_RX_RINGS - 1)] = 0 };
static int num_rx_ring_sz = 0;
...
module_param_array(tx_fifo_len, int, num_tx_fifo_len, 0);
module_param(rx_ring_num, int, 0);
module_param_array(rx_ring_sz, int, num_rx_ring_sz, 0);
