...
static int num_full_duplex = 0;
static int num_hw_checksums = 0;
static int num_flow_ctrl = 0;
static int num_enable_wol = 0;

module_param(debug, int, 0);
module_param(global_options, int, 0);
module_param_array(options, int, num_options, 0);
module_param(global_full_duplex, int, 0);
module_param_array(full_duplex, int, num_full_duplex, 0);
module_param_array(hw_checksums, int, num_hw_checksums, 0);
module_param_array(flow_ctrl, int, num_flow_ctrl, 0);
module_param(global_enable_wol, int, 0);
module_param_array(enable_wol, int, num_enable_wol, 0);
