...
zfcp_fsf_open_port(struct zfcp_erp_action *erp_action)
{
	...
	fsf_req->data.open_port.port = erp_action->port;
	fsf_req->erp_action = erp_action;
	erp_action->fsf_req = fsf_req;
...
zfcp_fsf_close_port(struct zfcp_erp_action *erp_action)
{
	...
	fsf_req->data.close_port.port = erp_action->port;
...
zfcp_fsf_close_physical_port(struct zfcp_erp_action *erp_action)
{
	...
	fsf_req->data.close_physical_port.port = erp_action->port;
	/* port to be closeed */
	fsf_req->qtcb->header.port_handle = erp_action->port->handle;
	fsf_req->erp_action = erp_action;
	erp_action->fsf_req = fsf_req;
...
zfcp_fsf_open_unit(struct zfcp_erp_action *erp_action)
{
	...
	fsf_req->qtcb->bottom.support.option = FSF_OPEN_LUN_SUPPRESS_BOXING;
...
zfcp_fsf_close_unit(struct zfcp_erp_action *erp_action)
{
	...
	fsf_req->data.close_unit.unit = erp_action->unit;
	fsf_req->erp_action = erp_action;
	erp_action->fsf_req = fsf_req;
