...
{
	ata_host_request_pm(host, PCI_D0, ATA_EH_SOFTRESET,
			    ATA_EHI_NO_AUTOPSY | ATA_EHI_QUIET, 0);
	host->dev->power.power_state = PCI_D0;
}
...
void ata_pci_device_do_suspend(struct pci_dev *pdev, pm_message_t mesg)
{
	...
	pci_save_state(pdev, host->pci_cfg_state);
...
void ata_pci_device_do_resume(struct pci_dev *pdev)
{
	...
	pci_restore_state(pdev, host->pci_cfg_state);
