 ...
 */
void *mempool_kmalloc(int gfp_mask, void *pool_data)
{
			 ...
			 unsigned cmd, unsigned long data)
{
	...
	case HDIO_GETGEO:
	{
		...
		virtblk_getgeo(inode->i_bdev, &geo);

		if (copy_to_user((struct hd_geometry __user *)data, &geo,
				 sizeof(geo)))
                        return -EFAULT;
...
static struct virtio_driver virtio_blk = {
	...
	.driver.name =	__stringify(KBUILD_MODNAME),
	.id_table =	id_table,
	.probe =	virtblk_probe,
