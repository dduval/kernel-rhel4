...
struct TCP_Server_Info {
	...
	unsigned noblocksnd:1;		/* use blocking sendmsg */
	unsigned noautotune:1;		/* do not autotune send buf sizes */
...
struct cifsSesInfo {
	...
	char *domainName;
	char *password;
	unsigned need_reconnect:1; /* connection reset, uid now invalid */
};
...
struct cifsTconInfo {
	...
	unsigned need_reconnect:1; /* connection reset, tid now invalid */
...
struct cifsInodeInfo {
	...
	unsigned delete_pending:1;		/* DELETE_ON_CLOSE is set */
