...
#if 0				/* XXXAP */
	xprintk("mem_init: entry_trampoline_setup\n");
	entry_trampoline_setup();
	xprintk("mem_init: entry_trampoline_setup done\n");
#endif
	default_ldt_page = virt_to_page(default_ldt); /* XXXAP cpu_init load_LDT */
