...
{
	panic("sn2_global_tlb_purge called");
}
/**
 * sn2_global_tlb_purge_new - globally purge translation cache of virtual address range
...
void
sn2_global_tlb_purge_new(struct mm_struct *mm, unsigned long start,
		     unsigned long end, unsigned long nbits)
{
