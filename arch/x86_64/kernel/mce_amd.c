...
#define VERSION "version 1.00.9-rhel4"
#define NR_BANKS 5
...
void __init mce_amd_feature_init(struct cpuinfo_x86 *c)
{
	int bank;
...
static __init int threshold_create_bank(unsigned int cpu, int bank)
{
	int err = 0;
...
static __init int threshold_create_device(unsigned int cpu)
{
	int bank;
	int err = 0;
...
static __init void threshold_create_symlinks(unsigned int cpu)
{
}
static __init void threshold_remove_symlinks(unsigned int cpu)
{
}
static void threshold_remove_device(unsigned int cpu)
{
}
/* older 2.6 kernel does not have CPU_DOWN hotplug stuff */
#ifndef CPU_DOWN_PREPARE
#define CPU_DOWN_PREPARE -1
#endif
#ifndef CPU_DOWN_FAILED
#define CPU_DOWN_FAILED -2
#endif

/* get notified when a cpu comes on/off */
static __init int threshold_cpu_callback(struct notifier_block *nfb,
